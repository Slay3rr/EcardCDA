pipeline {
    ...
    stages {
        ...
        stage('Configuration de l\'environnement') {
            steps {
                script {
                    // Construire la configuration en plusieurs parties
                    def dbUrl = "mysql://root:routitop@127.0.0.1:3306/${DEPLOY_DIR}?serverVersion=8.3.0&charset=utf8mb4"
                    def corsOrigin = "'^https?://(localhost|127\\.0\\.0\\.1|web006\\.azure\\.certif\\.academy)(:[0-9]+)?\\\\$'"
